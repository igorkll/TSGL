...
void tsgl_framebuffer_pushFast(tsgl_framebuffer* framebuffer, tsgl_pos x, tsgl_pos y, tsgl_sprite* sprite); //an extremely dumb and simplistic function. supports only the 565/666/888 color mode, does not support rotated framebuffers, not as a target, not as a renderable one. It does not support flip and rotation of sprites. does not support transparency. Because it works fast. You also need to disable incomplete sending.
