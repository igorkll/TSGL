...
//void tsgl_gfx_text(void* arg, TSGL_GFX_SET_REFERENCE(set), TSGL_GFX_FILL_REFERENCE(fill), tsgl_pos x, tsgl_pos y, tsgl_rawcolor bg, tsgl_rawcolor fg, , float scale, const char* text);